...
import { Home, BookOpen, FileText, Image, MessageSquare, LogOut, RefreshCw, Download, FileArchive } from "lucide-react";
...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { to: "/admin/cbz-upload", icon: FileArchive, label: "Upload CBZ" },
  ];
